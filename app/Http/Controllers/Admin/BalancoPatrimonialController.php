...
use Money\Currency;
class BalancoPatrimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $existe = BalancoPatrimonial::whereRaw(
        ...
        BalancoPatrimonial::where('type', $typeCatNormalizado)
        ...
        foreach ($dados as $item) {
            foreach ($item->items as $tabela => $dados_r) {
                ...
                $registro = new BalancoPatrimonial();
