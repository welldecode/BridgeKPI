...
class Dre extends Component
{
    ...
    {
        return view('livewire.admin.demo.dre')->layout('layouts.admin');
    }
    ...
    public function getDados()
    {
        ...
        $this->categorys = CategoryDre::all();
     ...
     public function saveDeleteDados($data)
    {
        ...
        $query = Dres::where('type', $this->type);
