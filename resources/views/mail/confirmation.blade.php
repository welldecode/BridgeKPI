...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="content-head">
            <img src="https://i.imgur.com/hgXV0Wu.png"
            height="70" width="200" alt="">
        </div>
                ...
                @php
                    $template->content = str_replace( 
                        [
                            ...
                            'Bridge KPI',
                            'http://bridgeskpi.com.br/',
                            'http://bridgeskpi.com.br//forgot-password/retrieve/'.$user->password_reset_code,
                            'http://bridgeskpi.com.br/register?aff='.$user->affiliate_code,
                            $user->name,
                             'http://bridgeskpi.com.br/confirm/email/'.$user->email_confirmation_code
                        ],
                        $template->content
                    );
                @endphp
