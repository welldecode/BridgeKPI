<div>
    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                <div class="col-12 col-sm d-flex flex-column">
                                    <h3 class="h2">Bem-vindo de volta, <br> {{ auth()->user()->first_name }}</h3>
                                    <p class="text-muted">Análise rápida de liquidez, rentabilidade e endividamento
                                        para decisões estratégicas.</p>
                                    <div class="row g-5 mt-auto">
                                        <div class="col-auto">
                                            <div class="subheader">Ultimos Dados</div>
                                    ...
                                    <a href="./illustrations.html">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="200" fill="none"
                                            ...
                                            <path
                                                ...
                                                opacity="0.02" class="tblr-illustrations-good-info-a"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#D6D8E2" opacity="0.5" class="tblr-illustrations-good-info-b">
                                            </path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#232B41" class="tblr-illustrations-good-info-c"></path>
                                            <path
                ...
                <div class="col-sm-6 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h2">Distribuição de Receita Liquida</h3>
                            <p class="text-muted">Análise os graficos dos seus indicadores.</p>
                            <div class="w-full flex justify-center">
                                <div>
                                    <div class="mb-4"> 
                                        <select wire:model="periodicidade" wire:change="gerarKpis"
                                    ...
                                    {{-- <div class="mb-4">
                                        ...
                                        <select wire:model="anoSelecionado" wire:change="gerarKpis"
                                            wire:key="{{ $periodicidade }}" id="anoSelecionado"
                                    ...
                                    {{-- Cartões --}}
                                    <div class="kpi-wrapper flex items-center gap-2 ">
                                        @foreach ($kpis as $kpi)
                                            <div class="border border-zinc-100 rounded-md "
                                                style="width: calc(100% / 2  )" wire:key="{{ $kpi['id'] }}">
                                                <div class="kpi-head">
                                                    <span
                                                        class="kpi-title text-base font-bold p-2 py-4">{{ $kpi['title'] }}</span>
                                                    <span class="kpi-value">
                                                        {{ number_format($kpi['valor'], 0, ',', '.') }}{{ $kpi['sufix'] }}
                                                    </span>
                                                </div>
                                                <div class="kpi-body">
                                                    <div id="chart-{{ $kpi['id'] }}" wire:ignore></div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
        ...
        @push('scripts')
       <script>
    Livewire.on('atualizar-kpis', data => {
        console.log('atualizando...', data);

        if (!data || !Array.isArray(data.kpis) || !Array.isArray(data.anos)) {
            console.warn('Dados inválidos recebidos para renderKpis', data);
            return;
        }

        renderKpis(data.anos, data.kpis);
    });

    function renderKpis(anos, kpis) {
        kpis.forEach(kpi => {
            const el = document.querySelector('#chart-' + kpi.id);
            if (!el) return;
